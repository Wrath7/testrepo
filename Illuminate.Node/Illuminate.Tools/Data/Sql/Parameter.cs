...
namespace Illuminate.Tools.Data.Sql
{
	...
	public class Parameter
	{
		...
		public string Name 
		{
			...
			set
			{
				if (value.Length == 0) { throw new Exceptions.InvalidParameterException("Name can not be zero length"); }
				_Name = value;
			}
		}
		...
		{
			if (name.Length == 0) { throw new Exceptions.InvalidParameterException("Name can not be zero length"); }
