...
namespace Amazon.SQS.Model
{
    ...
    public class DeleteQueueResponse
    {
        ...
        public DeleteQueueResponse WithResponseMetadata(ResponseMetadata responseMetadata)
        {
        ...
        public String ToXML() {
            ...
            xml.Append("<DeleteQueueResponse xmlns=\"http://queue.amazonaws.com/doc/2008-01-01/\">");
            ...
            xml.Append("</DeleteQueueResponse>");
            return xml.ToString();
        }
